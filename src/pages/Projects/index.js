    ...
    return (
        <div>
            <div className="projects">
                <Header title="Veja como é nosso dia a dia:" />
            </div>
            ...
            <div className="projproj">
                <h3>Além dessas atividades na comunidade, temos outros dois projetos:</h3>
                <div className="grid-proj">
                    <div className="textpart">
                        <h2>Cores Femininas</h2>
            ...
            <div className="premios">
                ...
                <div className="galeria pageproj">
                    <div className="first">
